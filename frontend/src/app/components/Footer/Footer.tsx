...
const Footer = () => {
  return (
    <footer className="pt-16 text-white max-w-7xl mx-auto">
      <div className="w-full border-gray-300 border-t lg:mx-auto md:mx-auto">
        <div className="container mx-auto py-12">
          <div className="xl:flex lg:flex md:flex pt-6">
            ...
            <div className="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
              <ul>
                <li className=" font-bold text-xl mb-6">Getting Started</li>
                <li className="text-base hover:underline mb-5">
                  <a href="javascript:void(0)">About Us</a>
                </li>
                <li className="text-base   mb-5">
                  <a href="javascript:void(0)">Guidelines and how to</a>
            ...
            <div className="w-11/12 xl:w-1/6 lg:w-2/5 mx-auto lg:mx-0 xl:mx-0 pt-3 xl:flex xl:justify-end pl-3 sm:pl-0">
              <ul>
                <li className=" font-bold text-xl mb-6">Resources</li>
                <li className="text-base   mb-5">
          ...
          <div className="xl:flex flex-wrap justify-between xl:mt-24 mt-16 pb-6 pl-3 sm:pl-0">
            <div className="w-11/12 xl:w-2/6 mx-auto lg:mx-0 xl:mx-0 mb-6 xl:mb-0">
              <p className="text-base">
                2023 Abhishek Bhat. All Rights Reserved
              </p>
            </div>
